          ...
          <Switch>
            ...
            if(!isLogged)
              ...
              <Route path="/add_user" component={()=>{
                ...
                return <AddUsers sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              ...
              <Route path="/content_master_list" component={()=>{
                
                return <ContentMasterList sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              <Route path="/content_master_add" component={()=>{
                
                return <ContentMasterAdd sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              <Route path="/add_portal" component={()=>{
                
                return <AddPortal sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              <Route path="/list_portal" component={()=>{
                
                return <ListPortal sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              <Route path="/content_portal_mapping" component={()=>{
                
                return <ContentPortalMapping sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
              <Route path="/review_content" component={()=>{
                
                return <ReviewContent sidebar={sidebarcomponent} footer={footerComponent} header={headercomponent}/>
              }} />
