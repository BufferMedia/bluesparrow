...
class FeatureList extends React.Component{
     ...
     loadFeatures = async => {
             try{
                    axios.get('feature', axios.getHeaders())
                    .then( resp => {
                        console.log(resp.data.data.features)
                        this.setState({featureList: resp.data.data.features.map( features => {
                                return{
                                        id: features.id,
                                        name: features.name
                                }
                            ...
                            <div className="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-xl-4 order-1 order-xl-2 m--align-right">
                                        <a href="feature_add" className="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                            <span>
