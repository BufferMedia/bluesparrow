			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						...
						<div class="mr-auto">
                                    <h3 class="m-subheader__title m-subheader__title--separator">Publisher</h3>
									...
									<form class="m-form m-form--fit m-form--label-align-right">
										...
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group">
												...
												<select class="form-control m-input m-input--square col-lg-12" id="">
													<option disabled selected value="">Select Content Portal*</option>
										...
										<div class="m-portlet__body">
											...
											<label class="form-control-label">
												...
												<select class="form-control m-input m-input--square col-lg-12" id="">
													<option disabled selected value="">Select Content Partner*</option>
										...
										<div class="m-portlet__body">
											...
											<label class="form-control-label">
												...
												<select class="form-control m-input m-input--square col-lg-12" id="">
													<option disabled selected value="">Select Sub Content Category*</option>
													<option value="">Education Non-Fiction EBook/Audiobook</option>
													<option value="">Art Fiction EBook/Audiobook</option>
													<option value="">Literature Fiction EBook/AudiobookBook</option>
													<option value="">Whitepaper Non-Fiction Audiobook</option>
										...
										<div class="m-portlet__body">
											...
											<label class="form-control-label">
												...
												<select class="form-control m-input m-input--square col-lg-12" id="">
													<option disabled selected value="">Select Content Category*</option>
										...
										<div class="m-portlet__foot m-portlet__foot--fit">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													<button type="reset" class="btn btn-primary">MAP</button>
												</div>
											</div>
											</div>
										</div>
