                ...
                <div className="m-widget27 m-portlet-fit--sides">
                  <div className="m-widget27__pic">
                    ...
                    <div className="m-widget27__btn">
                      <button
                        type="button"
                        className="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--bolder"
                      >
                  ...
                  <div className="m-widget27__container">
                    {/*<!-- begin::Nav pills -->*/}
                    <ul
                      className="m-widget27__nav-items nav nav-pills nav-fill"
                      role="tablist"
                    >
                          ...
                          <div className="col">
                            <div className="m-widget27__legends">
                              <div className="m-widget27__legend">
                                ...
                                <span className="m-widget27__legend-text">
                                  37% Case
                                </span>
                              </div>
                              <div className="m-widget27__legend">
              ...
              <div className="m-portlet__body">
                <div className="m-widget28">
                  ...
                  <div className="m-widget28__container">
                    {/*<!-- begin::Nav pills -->*/}
                    <ul
                      className="m-widget28__nav-items nav nav-pills nav-fill"
                      role="tablist"
                    >
                      <li className="m-widget28__nav-item nav-item">
                        ...
                        >
                          <span>
                            <i className="fa flaticon-pie-chart"></i>
                          </span>
                          <span>GMI Taxes</span>
                        </a>
                      </li>
                      <li className="m-widget28__nav-item nav-item">
                        ...
                        >
                          <span>
                            <i className="fa flaticon-file-1"></i>
                          </span>
                      ...
                      <li className="m-widget28__nav-item nav-item">
                        ...
                        >
                          <span>
                            <i className="fa flaticon-clipboard"></i>
                          </span>
                    ...
                    <div className="m-widget28__tab tab-content">
                      <div
                        id="menu11"
                        className="m-widget28__tab-container tab-pane active"
                      >
                      ...
                      <div
                        id="menu21"
                        className="m-widget28__tab-container tab-pane fade"
                      >
                        <div className="m-widget28__tab-items">
                          <div className="m-widget28__tab-item">
                            <span>Project Description</span>
          ...
          <div className="col-xl-6">
            ...
            <div className="m-portlet m-portlet--full-height ">
              <div className="m-portlet__head">
                <div className="m-portlet__head-caption">
                  <div className="m-portlet__head-title">
                    <h3 className="m-portlet__head-text">Tasks</h3>
                  </div>
                </div>
                <div className="m-portlet__head-tools">
                  <ul
                ...
                <div className="m-widget3">
                  <div className="m-widget3__item">
                    <div className="m-widget3__header">
                      ...
                      <div className="m-widget3__info">
                        ...
                        <br />
                        <span className="m-widget3__time">2 day ago</span>
                      </div>
                  ...
                  <div className="m-widget3__item">
                    <div className="m-widget3__header">
                      ...
                      <div className="m-widget3__info">
                        ...
                        <br />
                        <span className="m-widget3__time">1 day ago</span>
                      </div>
                  ...
                  <div className="m-widget3__item">
                    <div className="m-widget3__header">
                      ...
                      <div className="m-widget3__info">
                        <span className="m-widget3__username">Deb Gibson</span>
                        <br />
                        <span className="m-widget3__time">3 weeks ago</span>
                      </div>
          ...
          <div className="col-xl-6 col-lg-12">
            ...
            <div className="m-portlet  m-portlet--full-height ">
              <div className="m-portlet__head">
                <div className="m-portlet__head-caption">
                  <div className="m-portlet__head-title">
                    <h3 className="m-portlet__head-text">Recent Activities</h3>
                  </div>
                </div>
                <div className="m-portlet__head-tools">
                  <ul className="m-portlet__nav">
                    ...
                    <div className="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                      ...
                      <div className="m-timeline-2__item m--margin-top-30">
                        ...
                        <div className="m-timeline-2__item-text m--padding-top-5">
                          ...
                          <a
                            href="#"
                            className="m-link m-link--brand m--font-bolder"
                          >
                            USD 700
                          </a>{" "}
                          To ESL.
          ...
          <div className="col-xl-8">
            ...
            <div className="m-portlet m-portlet--full-height ">
              <div className="m-portlet__head">
                <div className="m-portlet__head-caption">
                  <div className="m-portlet__head-title">
                    <h3 className="m-portlet__head-text">Best Sellers</h3>
                  </div>
                </div>
                <div className="m-portlet__head-tools">
                  <ul
                        ...
                        <div className="m-widget5__content">
                          ...
                          <div className="m-widget5__section">
                            ...
                            <div className="m-widget5__info">
                              <span className="m-widget5__author">Author:</span>
                ...
                <div className="m-widget4">
                  <div className="m-widget4__item">
                    ...
                    <div className="m-widget4__info">
                      <span className="m-widget4__title">Trump Themes</span>
                      <br />
                  ...
                  <div className="m-widget4__item">
                    ...
                    <div className="m-widget4__info">
                      <span className="m-widget4__title">GreenMakers</span>
                      <br />
                      <span className="m-widget4__sub">
