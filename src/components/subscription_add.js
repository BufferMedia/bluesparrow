								...
								<div class="m-portlet__body">
								  ...
								  <div class="col-lg-6 col-md-12 col-sm-12">
										<label for="example-text-input" >
											...
											<select class="form-control m-input m-input--air" id="currencySelector1">
												<option value="ngn">
													Nigeria - NGN
												</option>
												<option value="ghs">
									  ...
									  <div class="col-lg-12 col-md-12 col-sm-12">
											...
											<input type="text" class="form-control m-input m-input--square m-input--air" id="exampleInputEmail1" placeholder="Subscription Name"/>
										</div>
										
										
										<div class="col-form-label col-lg-3 col-sm-12">
									   <div class="alert alert-primary m--margin-top-10" role="alert">
									   ...
									   <input type="text" class="form-control m-input m-input--air" id="price" placeholder="Enter Price"/>
										
									   <div class="input-group-append border">
									  
												<div class="currency1 m--margin-top-10" style={{padding: "0 4px"}} data-currencyName="ngn"><span><h5>NGN</h5></span></div>
