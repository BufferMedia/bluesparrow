								...
								<div class="m-portlet__body">
									<div class="form-group m-form__group row">
										...
										<div class="col-form-label col-lg-8 col-sm-12 m--margin-top-10 offset-2 ">
											...
											<input type="text" class="form-control m-input m-input--square" id="price" name="name" placeholder="Input Feature name" value={this.state.name} onChange={(e) => {this.setState({name: e.target.value})}} required />
