...
class AddPortal extends React.Component{
    ...
    handleSubmit = (e) => {
        ...
        axios.post(`portals/create`, { name, description, content_types})
            .then(res => {
                if(res.data.status) {
                    this.setState({
                    ...
                    <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="m-subheader ">
                            <div class="d-flex align-items-center">
                                <div class="mr-auto">
                                    <h3 class="m-subheader__title m-subheader__title--separator">Portal</h3>
                                    ...
                                    <form class="m-form m-form--fit m-form--label-align-right" onSubmit={this.handleSubmit}>
										...
										<div class="form-group m-form__group">
												<div class="col-lg-12 m-form__group-sub">
													<input type="text" name="name" class="form-control m-input" placeholder="Title" value={this.state.name} onChange={(e) => {this.setState({name: e.target.value})}}/>
												</div>
										</div>
                                        <div class="form-group m-form__group">
											<div class="col-lg-12">
                                              <textarea class="form-control m-input" id="desc" placeholder="Portal Description" rows="3" name="description" onChange={(e) => {this.setState({description: e.target.value})}} value={this.state.description} required></textarea>
										</div>
									   </div>
                                       <div class="form-group m-form__group">
												<div className="col-sm-12">
                                                    <select className="form-control m-input m-input--air" onChange={(e) => {
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    ...
                                                    <div class="col-xl-12 col-lg-8 col-sm-12 col-md-12">
                                                        <div class="m-checkbox-inline">
                                                            {this.state.availableContentTypes !== null && this.state.availableContentTypes.map((s) => {
                                                                return (
                                                                    <label class="m-checkbox" key={s.id}>
                                                                        <input type="checkbox" checked={this.state.content_types.includes(`${s.id}`)} value={`${s.id}`} onChange={this.handleContentTypeChecked}/>
                                                                        {s.extension}
                                                                        <span></span>
                                                                    </label>
                                                                )
