...
class ContentCategoryAdd extends React.Component{
	...
	handleContentTypeChecked = (e) => {
	  ...
	  handleSubmit = (e) => {
		 ...
		 axios.post(`category/store`, { name, local_name, content_types})
		 .then( res => {
			 if(res.data.status){
				 this.setState({
	...
	loadCategory = async () => {
		 ...
		 .then(res => {
			 ...
			 this.setState({categoryList: res.data.data.map(category => {
				 return{
					 id: category.id,
					 name: category.name,
								...
								<form class="m-form m-form--fit m-form--label-align-right" onSubmit={this.handleSubmit}>
										<div class="m-portlet__body">
												<div class="form-group m-form__group row">							
													<div class="col-lg-12">
														<select name="portal" className="form-control m-input m-input--air" onChange ={ (e) => {
												...
												<div class="form-group m-form__group row">
													...
													<input type="text" name="name" class="form-control m-input" placeholder="Enter Title" onChange = {(e) =>{this.setState({name: e.target.value})}} value= { this.state.name}/>
													...
													<input type="text" name="local_name" class="form-control m-input" placeholder="Local Title" onChange={(e) => {this.setState({local_name: e.target.value})}} value = {this.state.local_name}/>
														<span class="m-form__help">
