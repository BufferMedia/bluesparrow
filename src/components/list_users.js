...
import { MDBDataTable, Row, Cols, Card, CardBody } from 'mdbreact';
     ...
     class ListUsers extends React.Component{
		...
		loadUsers = async () =>{
			...
			try{ 
				axios.get('users', axios.getHeaders())
					.then(resp => {
					...
					<div className="m-subheader ">
						<div className="d-flex align-items-center">
							<div className="mr-auto">
								<h3 className="m-subheader__title m-subheader__title--separator">User</h3>
								...
								<div className="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div className="row align-items-center">
										...
										<div className="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="add_user" className="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
