								...
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										...
										<div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="add_user" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
								...
								<table class="m-datatable" id="html_table" width="100%">
									...
									<tbody>
										<tr>
											...
											<td>username1</td>
											<td>password1</td>
											<td><button type="button" class="btn-status btn-success">Active</button></td>
										...
										<tr>
											...
											<td>username2</td>
											<td>password2</td>
											<td><button type="button" class="btn-status btn-warning">Inactive</button></td>
											<td><a href="#" class="ico edit"></a>Edit</td>
										</tr>										
										<tr>
											<td>3</td>
