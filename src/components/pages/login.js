...
class Login extends React.Component {
      ...
      <div className="m-login__signin">
        ...
        <form className="m-login__form m-form" action="">
          ...
          <div className="row form-group m-form__group m-login__form-sub">
            <div className="col m--align-left">
              <label className="m-checkbox m-checkbox--focus">
                <input type="checkbox" name="agree"/> I Agree the <a href="#" className="m-link m-link--focus">terms and
                conditions</a>.
                <span></span>
              </label>
          ...
          <div className="m-login__form-action">
            <button id="m_login_signup_submit" className="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Sign
              Up
            </button>
            <button id="m_login_signup_cancel"
                    className="btn btn-outline-focus  m-btn m-btn--pill m-btn--custom">Cancel
            </button>
          </div>
        </form>
      </div>
        ...
        <form className="m-login__form m-form" action="">
          ...
          <div className="m-login__form-action">
            <button id="m_login_forget_password_submit"
                    className="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Request
            </button>
  ...
  async login(e) {
    ...
    req.send({username: username, password: pwd}, (resp) => {
        ...
        if (typeof resp == "object") {
          ...
          if (access_token != null && refresh_token != null && token_type != null && time_expires != null) {
    ...
    return (
      <div className="m-login__signin">
        ...
        <form className="m-login__form m-form" action="" onSubmit={this.login.bind(this)}>
          ...
          <div className="form-group m-form__group">
            <input className="form-control m-input" type="text" placeholder="Email" name="email-signin"
                   id="username_login" onChange={(e) => {
              this.changeState("userName", e.target.value)
            }}/>
          </div>
          <div className="form-group m-form__group">
            <input className="form-control m-input m-login__form-input--last" type="password" placeholder="Password"
                   name="password" id="user_pwd_login" onChange={(e) => {
          ...
          <div className="row m-login__form-sub">
            ...
            <div className="col m--align-right">
              <a href="javascript:;" id="m_login_forget_password" className="m-link" onClick={() => {
                this.changeForm('reset')
              }}>Forget Password ?</a>
            </div>
          </div>
          <div className="m-login__form-action">
            <button id="m_login_signin_submit" className="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Sign
              In
            </button>
          </div>
        </form>
      ...
      <div className="m-grid m-grid--hor m-grid--root m-page">
        <div
              ...
              <div className="m-stack__item m-stack__item--center">
                <div className="m-login__account">
                  ...
                  {this.state.current == "signup" ?
                    <a href="javascript:;" className="m-link m-link--focus m-login__account-link"
                       onClick={this.changeForm.bind(this, "signin")}>Sign In</a> :
                    <a href="javascript:;" id="m_login_signup" className="m-link m-link--focus m-login__account-link"
                       onClick={this.changeForm.bind(this, "signup")}>Sign Up</a>
                  }
          ...
          <div
            ...
            style={{backgroundImage: `url('/assets/default/media/img/bg/bg-01.jpg')`}}>
