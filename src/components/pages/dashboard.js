                ...
                <div className="m-portlet__head-tools">
                  <ul className="m-portlet__nav">
                    <li
                      ...
                      <a href="#"
                         className="m-portlet__nav-link m-dropdown__toggle dropdown-toggle btn btn--sm m-btn--pill m-btn btn-outline-light m-btn--hover-light">
                        2018
                      </a>
                ...
                <div className="m-widget27 m-portlet-fit--sides">
                  <div className="m-widget27__pic">
                    ...
                    <div className="m-widget27__btn">
                      <button type="button"
                              className="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--bolder">Inclusive All
                        Earnings
                      </button>
                    </div>
                  </div>
                  <div className="m-widget27__container">
                    ...
                    <ul className="m-widget27__nav-items nav nav-pills nav-fill" role="tablist">
                      <li className="m-widget27__nav-item nav-item">
                        <a className="nav-link active" data-toggle="pill" href="#m_personal_income_quater_1">Quater
                          1</a>
                      </li>
                      <li className="m-widget27__nav-item nav-item">
                    ...
                    <div className="m-widget27__tab tab-content m-widget27--no-padding">
                      <div id="m_personal_income_quater_1" className="tab-pane active">
                        <div className="row  align-items-center">
                          <div className="col">
                            <div id="m_chart_personal_income_quater_1" className="m-widget27__chart"
                                 style={{height: '160px'}}>
                      ...
                      <div id="m_personal_income_quater_2" className="tab-pane fade">
                        <div className="row  align-items-center">
                          <div className="col">
                            <div id="m_chart_personal_income_quater_2" className="m-widget27__chart"
                                 style={{height: '160px'}}>
                      ...
                      <div id="m_personal_income_quater_3" className="tab-pane fade">
                        <div className="row  align-items-center">
                          <div className="col">
                            <div id="m_chart_personal_income_quater_3" className="m-widget27__chart"
                                 style={{height: '160px'}}>
                      ...
                      <div id="m_personal_income_quater_4" className="tab-pane fade">
                        <div className="row  align-items-center">
                          <div className="col">
                            <div id="m_chart_personal_income_quater_4" className="m-widget27__chart"
                                 style={{height: '160px'}}>
                  ...
                  <div className="m-widget28__container">
                    ...
                    <ul className="m-widget28__nav-items nav nav-pills nav-fill" role="tablist">
                      <li className="m-widget28__nav-item nav-item">
                        <a className="nav-link active" data-toggle="pill" href="#menu11"><span><i
                          className="fa flaticon-pie-chart"></i></span><span>GMI Taxes</span></a>
                      </li>
                      <li className="m-widget28__nav-item nav-item">
                        <a className="nav-link" data-toggle="pill" href="#menu21"><span><i
                          className="fa flaticon-file-1"></i></span><span>IMT Invoice</span></a>
                      </li>
                      <li className="m-widget28__nav-item nav-item">
                        <a className="nav-link" data-toggle="pill" href="#menu31"><span><i
                          className="fa flaticon-clipboard"></i></span><span>Main Notes</span></a>
                      </li>
                    </ul>
                ...
                <div className="m-portlet__head-tools">
                  <ul
                    ...
                    <li className="nav-item m-tabs__item">
                      <a className="nav-link m-tabs__link active" data-toggle="tab" href="#m_widget2_tab1_content"
                         role="tab">
                        Today
                      </a>
                    </li>
                ...
                <div className="m-portlet__head-tools">
                  <ul className="m-portlet__nav">
                    <li
                      ...
                      <a href="#"
                         className="m-portlet__nav-link m-portlet__nav-link--icon m-portlet__nav-link--icon-xl m-dropdown__toggle">
                ...
                <div className="m-widget3">
                  ...
                  <div className="m-widget3__item">
                    ...
                    <div className="m-widget3__body">
                      <p className="m-widget3__text">
                        Lorem ipsum dolor sit amet,consectetuer edipiscing elit,sed diam nonummy nibh euismod
                        tinciduntut laoreet doloremagna aliquam erat volutpat.Ut wisi enim ad minim veniam,quis nostrud
                          ...
                          <div className="m-dropdown__body">
                            <div className="m-dropdown__content">
                              <ul className="m-nav">
                                ...
                                <li className="m-nav__item">
                                  <a href="#"
                                     className="btn btn-outline-danger m-btn m-btn--pill m-btn--wide btn-sm">Cancel</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                  ...
                  <div className="m-timeline-2">
                    <div className="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                      ...
                      <div className="m-timeline-2__item m--margin-top-30">
                        ...
                        <div className="m-timeline-2__item-text m--padding-top-5">
                          Placed a new order in <a href="#" className="m-link m-link--brand m--font-bolder">SIGNATURE
                      ...
                      <div className="m-timeline-2__item m--margin-top-30">
                        ...
                        <div className="m-timeline-2__item-text m--padding-top-5">
                          Received a new feedback on <a href="#" className="m-link m-link--brand m--font-bolder">FinancePro
                          App</a> product.
                        </div>
                      </div>
                    </div>
              ...
              <div className="m-portlet__head">
                ...
                <div className="m-portlet__head-tools">
                  <ul
                    ...
                    role="tablist">
                    <li className="nav-item m-tabs__item">
                      <a className="nav-link m-tabs__link active" data-toggle="tab" href="#m_widget5_tab1_content"
                         role="tab">
                        Last Month
                      </a>
                    </li>
