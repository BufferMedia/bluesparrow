...
import SideNavigation from '../widgets/sidebar.js';
import Header from '../widgets/header.js'
import Scripts from '../includes/script.js'
import Footer from '../widgets/footer'
import Quicksidebar from '../widgets/quicksidebar'
                    ...
                    <div className="row">
                        ...
                        <div className="row">
                          <div className="col-sm-6">
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Page Views by
                                traffic Type
                              </div>
                            ...
                            <br/>
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Page Views By Day of
                                week <span className="pull-right"><i className="flaticon-graph"></i></span></div>

                              <div className="allviewsDashboard">
                                <div className="view-single"
                                     style={{padding: '15px', borderBottom: '1px solid #efefef'}}>
                          ...
                          <div className="col-sm-6">
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Total time on site
                              </div>
                            ...
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Unique Visitors By
                                Visitors' type
                              </div>
                      ...
                      <div className="col-sm-6">
                        <div className="row">
                          <div className="col-sm-6">
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Unique Visitors
                              </div>
                          ...
                          <div className="col-sm-12">
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Unique Visitors and
                                visits
                              </div>
                            ...
                            <div style={{borderRadius: '10px', boxShadow: '3px 4px 10px #ccc'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}>Top 10 Content
                                Providers
                              </div>
                        ...
                        <div className="row" style={{border: '5px solid #eee'}}>
                          ...
                          <div className="col-sm-4">
                            <div style={{borderRadius: '10px'}}>
                              <div style={{padding: '10px', borderBottom: '1px solid #efefef'}}><strong>Views By
                                Country</strong></div>
