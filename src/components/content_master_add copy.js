                ...
                <div class="m-content">
                  ...
                  <div class="m-portlet m-portlet--full-height">
                    ...
                    <div class="m-portlet__head">
                      <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                          <h3 class="m-portlet__head-text">Add Content</h3>
                        </div>
                      </div>
                    ...
                    <div class="m-portlet__body m-portlet__body--no-padding">
                      {/*<!--begin: Form Wizard-->*/}
                      <div
                        class="m-wizard m-wizard--3 m-wizard--success"
                        id="m_wizard"
                      >
                                      ...
                                      <div class="col-xl-9 col-lg-9">
                                        <select
                                          ...
                                          onChange={e =>
                                            this.setState({
                                              selectedContentType:
                                                e.target.value,
                                              selectedContentTypeName: e.target.getAttribute(
                                                "data-name"
                                              )
                                            })
                                          }
                                        >
                                          ...
                                          {this.availableContentTypes !==
                                            null &&
                                            this.state.availableContentTypes.map(
                                              cont => (
                                                <option
                                                  key={cont.id}
                                                  value={cont.id}
                                    ...
                                    <div class="form-group m-form__group row">
                                      ...
                                      <div class="col-xl-9 col-lg-9">
                                        <select
                                          ...
                                          onChange={e => {
                                            this.setState({
                                              ...
                                              selectedCategoryName: e.target.getAttribute(
                                                "data-name"
                                              )
                                            });
                                          }}
                                        >
                                          ...
                                          {this.state.availableCategory !==
                                            null &&
                                            this.state.availableCategory.map(
                                              cat => (
                                                <option
                                                  key={cat.id}
                                                  value={cat.id}
                                  ...
                                  >
                                    ...
                                    <div class="col-lg-12">
                                      <div
                                        class="form-control m-input"
                                        disabled
                                      >{`Content Type: ${this.state.selectedContentTypeName}`}</div>
                                      <div
                                        class="form-control m-input"
                                        disabled
                                      >{`Category: ${this.state.selectedCategoryName}`}</div>
                                      <div
                                        class="form-control m-input"
                                        disabled
                                    ...
                                    <div class="form-group m-form__group row">
                                      <div class="col-lg-12">
                                        ...
                                        >
                                          ...
                                          {this.state.availableMetadata !==
                                            null &&
                                            this.state.availableMetadata.map(
                                              meta => (
                                                <option
                                                  key={meta.id}
                                                  value={meta.id}
