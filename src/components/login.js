      ...
      resp => {
        ...
        if (typeof resp === "object") {
          ...
          if (
            ...
            resp.token_type !== null &&
            resp.time_expires !== null
          ) {
      ...
      <div className="m-grid m-grid--hor m-grid--root m-page">
        ...
        >
                ...
                <div className="m-login__account">
                  ...
                  {this.state.current == "signup" ? (
                    <a
                      ...
                      onClick={this.changeForm.bind(this, "signin")}
                    >
                      Sign In
                    </a>
                  ) : (
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/assets/default/media/img/bg/bg-01.jpg')`
            }}
          >
