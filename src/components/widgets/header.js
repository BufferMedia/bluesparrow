          ...
          <div className="m-stack m-stack--ver m-stack--desktop">
            ...
            <div className="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
              ...
              <button className="m-aside-header-menu-mobile-close  m-aside-header-menu-mobile-close--skin-dark "
                      id="m_aside_header_menu_mobile_close_btn"><i className="la la-close"></i></button>
              <div id="m_header_menu"
                ...
                <ul className="m-menu__nav  m-menu__nav--submenu-arrow ">
                  <li className="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click"
                    ...
                    className="m-menu__link-icon flaticon-add"></i><span className="m-menu__link-text">Actions</span><i
                    className="m-menu__hor-arrow la la-angle-down"></i><i
                    className="m-menu__ver-arrow la la-angle-right"></i></a>
                    <div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left"><span
                      className="m-menu__arrow m-menu__arrow--adjust"></span>
                      <ul className="m-menu__subnav">
                        <li className="m-menu__item " aria-haspopup="true"><a href="content_master_add.html"
                                                                              className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-file"></i><span className="m-menu__link-text">Add Content</span></a>
                        </li>
                        <li className="m-menu__item" aria-haspopup="true"><a href="#" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-file"></i><span className="m-menu__link-text">Create Campaign</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="#"
                                                                                                       className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-users"></i><span
                          className="m-menu__link-text">Add User</span></a>
                        </li>
                      </ul>
                    </div>
                  </li>
                  <li className="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click"
                      m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:;"
                                                                       className="m-menu__link m-menu__toggle"
                                                                       title="Non functional dummy link"><i
                    className="m-menu__link-icon flaticon-line-graph"></i><span
                    className="m-menu__link-text">Reports</span><i className="m-menu__hor-arrow la la-angle-down"></i><i
                    className="m-menu__ver-arrow la la-angle-right"></i></a>
                    <div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left"><span
                      className="m-menu__arrow m-menu__arrow--adjust"></span>
                      <ul className="m-menu__subnav">
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-business"></i><span className="m-menu__link-text">Subscription Report</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-map"></i><span className="m-menu__link-text">Service Revenue Report</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-map"></i><span className="m-menu__link-text">Variable Billing Report</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-signs-1"></i><span className="m-menu__link-text">Content Delivery Report</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-folder"></i><span className="m-menu__link-text">Service Summary Report</span></a>
                        </li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a
                          href="header/actions.html" className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-cogwheel-2"></i><span className="m-menu__link-text">Service Detail Report</span></a>
                        </li>
                      </ul>
                    </div>
                  </li>
                  <li className="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click"
                      m-menu-link-redirect="1" aria-haspopup="true"><a href="javascript:;"
                                                                       className="m-menu__link m-menu__toggle"
                                                                       title="Non functional dummy link"><i
                    className="m-menu__link-icon flaticon-paper-plane"></i><span className="m-menu__link-title"> <span
                    className="m-menu__link-wrap"> <span className="m-menu__link-text">Apps</span> <span
                    className="m-menu__link-badge"></span>
												</span></span><i className="m-menu__hor-arrow la la-angle-down"></i><i
                    className="m-menu__ver-arrow la la-angle-right"></i></a>
                    <div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left"><span
                      className="m-menu__arrow m-menu__arrow--adjust"></span>
                      <ul className="m-menu__subnav">
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="#"
                                                                                                       className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-business"></i><span
                          className="m-menu__link-text">Application1</span></a></li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="#"
                                                                                                       className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-map"></i><span
                          className="m-menu__link-text">Application2</span></a></li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="#"
                                                                                                       className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-map"></i><span
                          className="m-menu__link-text">Application3</span></a></li>
                        <li className="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true"><a href="#"
                                                                                                       className="m-menu__link "><i
                          className="m-menu__link-icon flaticon-map"></i><span
                          className="m-menu__link-text">Application4</span></a></li>
                  ...
                  <ul className="m-topbar__nav m-nav m-nav--inline">
                      ...
                      <div className="m-dropdown__wrapper">
                        ...
                        <div className="m-dropdown__inner ">
                          <div className="m-dropdown__header">
                            <form className="m-list-search__form">
                              <div className="m-list-search__form-wrapper">
                                         ...
                                         className="m-list-search__form-input" placeholder="Search..."/>
																</span>
                          ...
                          <div className="m-dropdown__body">
                            <div className="m-dropdown__scrollable m-scrollable" data-scrollable="true"
                      ...
                      <div className="m-dropdown__wrapper">
                        ...
                        <div className="m-dropdown__inner">
                          <div className="m-dropdown__header m--align-center" style={{
                            "background": `url(assets/app/media/img/misc/notification_bg.jpg)`,
                            ...
                            <div className="m-dropdown__content">
                              <ul className="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand" role="tablist">
                                <li className="nav-item m-tabs__item">
                                  <a className="nav-link m-tabs__link active" data-toggle="tab"
                                     href="#topbar_notifications_notifications" role="tab">
                                    Alerts
                                  </a>
                                </li>
                                <li className="nav-item m-tabs__item">
                                  <a className="nav-link m-tabs__link" data-toggle="tab"
                              ...
                              <div className="tab-content">
                                <div className="tab-pane active" id="topbar_notifications_notifications"
                                     role="tabpanel">
                                  <div className="m-scrollable" data-scrollable="true" data-height="250"
                                    ...
                                    <div className="m-list-timeline m-list-timeline--skin-light">
                                      <div className="m-list-timeline__items">
                                        ...
                                        <div className="m-list-timeline__item">
                                          ...
                                          <span className="m-list-timeline__text">System shutdown <span
                                            className="m-badge m-badge--success m-badge--wide">pending</span></span>
                                        ...
                                        <div className="m-list-timeline__item">
                                          <span className="m-list-timeline__badge"></span>
                                          <span className="m-list-timeline__text">DB overloaded 80% <span
                                            className="m-badge m-badge--info m-badge--wide">settled</span></span>
                                          <span className="m-list-timeline__time">1 hr</span>
                                        </div>
                                        <div className="m-list-timeline__item">
                                          <span className="m-list-timeline__badge"></span>
                                          <span className="m-list-timeline__text">System error - <a href="#"
                                                                                                    className="m-link">Check</a></span>
                                          <span className="m-list-timeline__time">2 hrs</span>
                                        </div>
                                        <div className="m-list-timeline__item m-list-timeline__item--read">
                                          <span className="m-list-timeline__badge"></span>
                                          <span href="" className="m-list-timeline__text">New order received <span
                                            className="m-badge m-badge--danger m-badge--wide">urgent</span></span>
                    ...
                    <li
                      ...
                      <div className="m-dropdown__wrapper">
                        ...
                        <div className="m-dropdown__inner">
                          <div className="m-dropdown__header m--align-center" style={{
                            "backgroundImage": `url(assets/app/media/img/misc/quick_actions_bg.jpg)`,
                            backgroundSize: 'cover'
                          }}>
                    ...
                    <li
                      ...
                      <a href="#" className="m-nav__link m-dropdown__toggle">
												<span className="m-nav__link-text">
													<img className="m-topbar__language-selected-img"
                      ...
                      <div className="m-dropdown__wrapper">
                        ...
                        <div className="m-dropdown__inner">
                          <div className="m-dropdown__header m--align-center" style={{
                            "background": `url('assets/app/media/img/misc/quick_actions_bg.jpg')`,
                            backgroundSize: 'cover'
                          }}>
                              ...
                              <ul className="m-nav m-nav--skin-light">
                                <li className="m-nav__item m-nav__item--active">
                                  <a href="#" className="m-nav__link m-nav__link--active">
                                    <span className="m-nav__link-icon"><img className="m-topbar__language-img"
                                                                            src="assets/app/media/img/flags/020-flag.svg"/></span>
                                    <span
                                      className="m-nav__link-title m-topbar__language-text m-nav__link-text">USA</span>
                                  </a>
                                </li>
                                <li className="m-nav__item">
                                  <a href="#" className="m-nav__link">
																		<span className="m-nav__link-icon">
																		<img className="m-topbar__language-img"
                                         src="assets/app/media/img/flags/015-china.svg"/></span>
                                    <span
                                      className="m-nav__link-title m-topbar__language-text m-nav__link-text">China</span>
                                  </a>
                                </li>
                                <li className="m-nav__item">
                                  <a href="#" className="m-nav__link">
                                    ...
                                    <span
                                      className="m-nav__link-title m-topbar__language-text m-nav__link-text">Spain</span>
                                  </a>
                                </li>
                                <li className="m-nav__item">
                                  <a href="#" className="m-nav__link">
                                    ...
                                    <span
                                      className="m-nav__link-title m-topbar__language-text m-nav__link-text">Japan</span>
                                  </a>
                                </li>
                                <li className="m-nav__item">
                                  <a href="#" className="m-nav__link">
                                    ...
                                    <span
                                      className="m-nav__link-title m-topbar__language-text m-nav__link-text">Germany</span>
                                  </a>
                                </li>
                              </ul>
                            </div>
                    ...
                    <li
                      ...
                      <div className="m-dropdown__wrapper">
                        ...
                        <div className="m-dropdown__inner">
                          <div className="m-dropdown__header m--align-center" style={{
                            "background": `url(assets/app/media/img/misc/user_profile_bg.jpg)`,
                            backgroundSize: 'cover'
                          }}>
						...
						-->*/}
                              ...
                              <div className="m-card-user__details">
                                ...
                                <a href=""
                                   className="m-card-user__email m--font-weight-300 m-link">mark.andre@gmail.com</a>
                              </div>
                            </div>
                          </div>
                          <div className="m-dropdown__body">
                                  ...
                                  <a href="profile.html" className="m-nav__link">
                                    ...
                                    <span className="m-nav__link-title">
																			<span className="m-nav__link-wrap">
																				...
																				<span className="m-nav__link-badge"><span
                                          className="m-badge m-badge--success">2</span></span>
																			</span>
																		</span>
                                  </a>
                                </li>
