    ...
    return (
      <div id="m_quick_sidebar" className="m-quick-sidebar m-quick-sidebar--tabbed m-quick-sidebar--skin-light">
        <div className="m-quick-sidebar__content m--hide">
          <span id="m_quick_sidebar_close" className="m-quick-sidebar__close"><i className="la la-close"></i></span>
          <ul id="m_quick_sidebar_tabs" className="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand" role="tablist">
            <li className="nav-item m-tabs__item">
              <a className="nav-link m-tabs__link active" data-toggle="tab" href="#m_quick_sidebar_tabs_messenger"
                 role="tab">Messages</a>
            </li>
            <li className="nav-item m-tabs__item">
              <a className="nav-link m-tabs__link" data-toggle="tab" href="#m_quick_sidebar_tabs_settings"
                 role="tab">Settings</a>
            </li>
            <li className="nav-item m-tabs__item">
              <a className="nav-link m-tabs__link" data-toggle="tab" href="#m_quick_sidebar_tabs_logs"
                 role="tab">Logs</a>
            </li>
          </ul>
          <div className="tab-content">
            ...
            <div className="tab-pane" id="m_quick_sidebar_tabs_settings" role="tabpanel">
              ...
              <div className="m-list-timeline m-scrollable">
                <div className="m-list-timeline__group">
                  ...
                  <div className="m-list-timeline__items">
                    <div className="m-list-timeline__item">
                      ...
                      <a href="" className="m-list-timeline__text">12 new users registered <span
                        className="m-badge m-badge--warning m-badge--wide">important</span></a>
                      <span className="m-list-timeline__time">Just now</span>
                    </div>
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
                      <a href="" className="m-list-timeline__text">System shutdown</a>
                      <span className="m-list-timeline__time">11 mins</span>
                    </div>
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-danger"></span>
                      <a href="" className="m-list-timeline__text">New invoice received</a>
                      <span className="m-list-timeline__time">20 mins</span>
                    </div>
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-warning"></span>
                      <a href="" className="m-list-timeline__text">Database overloaded 89% <span
                        className="m-badge m-badge--success m-badge--wide">resolved</span></a>
                    ...
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
                      <a href="" className="m-list-timeline__text">Production server down <span
                        className="m-badge m-badge--danger m-badge--wide">pending</span></a>
                ...
                <div className="m-list-timeline__group">
                  ...
                  <div className="m-list-timeline__items">
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
                      <a href="" className="m-list-timeline__text">New order received <span
                        className="m-badge m-badge--info m-badge--wide">urgent</span></a>
                    ...
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
                      <a href="" className="m-list-timeline__text">System error <span
                        className="m-badge m-badge--info m-badge--wide">pending</span></a>
                      <span className="m-list-timeline__time">2 hrs</span>
                    </div>
                    <div className="m-list-timeline__item">
                      <span className="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
