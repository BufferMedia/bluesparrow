...
class Orders extends React.Component{
     constructor(props){
        ...
        loadOrders = async =>{
            try{
                axios.get('order/list', axios.getHeaders())
                    .then(resp =>{
                        console.log(resp.data.data.orders)
                        this.setState({orderList: resp.data.data.orders.map( order => {
                            return{
                                 id: order.id,
                                 price: order.price,
                                 currency: order.currency,
                                 portal: order.portal.name,
                                ...
                                <div className="m-subheader ">
                                    <div className="d-flex align-items-center">
                                        <div className="mr-auto">
                                            <h3 className="m-subheader__title m-subheader__title--separator">Billing</h3>
                                            <ul className="m-subheader__breadcrumbs m-nav m-nav--inline">
                                                ...
                                                <li className="m-nav__item">
                                                    <a href="" className="m-nav__link">
                                                        <span className="m-nav__link-text">Orders</span>
                                                    </a>
                                                </li>
                                                <li className="m-nav__separator">-</li>
                                            </ul>
                            ...
                            <div className="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                                <div className="row align-items-center">
                                            ...
                                            <div className="col-md-4">
                                                <div className="m-form__group m-form__group--inline">
                                                    ...
                                                    <div className="m-form__control">
                                                        <select className="form-control m-bootstrap-select" id="m_form_status">
                                   ...
                                   {/*  <div className="col-xl-4 order-1 order-xl-2 m--align-right">
                                        <a href="coupon_add" className="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                            <span>
    ...
    <ul className="m-nav-sticky" style={{"marginTop": "30px"}}>
        <li className="m-nav-sticky__item" data-toggle="m-tooltip" title="Documentation" data-placement="left">
            <a href="#" target="_blank"><i className="la la-code-fork"></i></a>
        </li>
        <li className="m-nav-sticky__item" data-toggle="m-tooltip" title="Support" data-placement="left">
            <a href="#" target="_blank"><i className="la la-life-ring"></i></a>
        </li>
    </ul>
